    ...
    return (
        <section className="py-24 overflow-x-clip" style={{
            ...
            <div className="container relative">
                ...
                <h1 className="text-6xl md:text-7xl lg:text-8xl font-medium text-center mt-6 max-w-4xl mx-auto">Impactful design, created effortlessly</h1>
                <p className="text-xl text-center text-white/50 mt-8 max-w-2xl mx-auto">
                    Design tools shouldn&apos;t slow you down.
                    Layers combines powerful features with an intuitive interface
                ...
                <form className="flex border border-white/15 rounded-full p-2 mt-8 max-w-lg mx-auto">
                    ...
                    />
                    <Button variant="primary" type="submit" size="sm" className="whitespace-nowrap">Sign up</Button>
                </form>
            </div>
        </section>
    )
